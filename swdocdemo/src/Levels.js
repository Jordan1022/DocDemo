...
export const levels = [
    ...
    {title:'Sweet Economy',text:" means the local, national and international alliance of participants; #|1|#, LPENTITIES, and ECOSYSTEMS, based on the open source SWEETBRIDGE Synchronized Commerce Platform that connects participants and ECOSYSTEMS together to provide services, opportunities, resources and value for PARTICIPANTS of the Economy. The SWEETBRIDGE Synchronized Commerce Platform automates and simplifies commerce transactions - BUSINESS ACTIVITIES - using automated contracts, automated accounting, automated risk management, automated settlement and PAYMENT that includes data security and access controls that protect identity, information, claims and proofs, all of which is designed to reduce error and fraud in commerce."},
    {title:'owned',text:' #|2|# an individual of the Sweet Economy'},
